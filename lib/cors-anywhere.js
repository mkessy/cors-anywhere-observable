  ...
  return function(req, res) {
    ...
    if (corsAnywhere.originWhitelist.length && corsAnywhere.originWhitelist.indexOf(origin) === -1) {
      ...
      res.end('The origin "' + origin + '" was not whitelisted by the operator of this proxy. ' + 
        '\nIf you are working in an Observable Notebook, check out ' + 
        'https://github.com/asg017/cors-anywhere-observable for more information.\n' + 
        'Quick fix: change the subdomain to "cors-anywhere" - e.g. ' + 
        'https://cors-anywhere.herokuapp.com/XXXXX');
      return;
    }
